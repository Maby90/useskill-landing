...
Analizza i tuoi contenuti, estrae il tuo tono di voce. Risultato: un documento con le regole precise per scrivere come te.
...
4. Carica il file `brand-voice-extractor.skill` (questo file)
...
2. Nelle impostazioni della sessione, carica il file `brand-voice-extractor.skill` come contesto
...
**Input:** 3-10 contenuti scritti da te (post, email, newsletter, pagine sito)

**Output:** Report completo del tono di voce con regole operative, parole-firma, anti-pattern e test di verifica
...
Tutte le altre Skill — alimenta il PROFILE.md che calibra tutto il sistema
